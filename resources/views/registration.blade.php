...
@section('content')
    <section class="bg-half d-table w-100" style="background: url('{{ asset('assets/images/aboutus.png') }}') bottom right;">
                            ...
                            <div class="card-body py-5">
                                ...
                                @if ($currentDate <= \Carbon\Carbon::parse($registration->end_date_early))
                                    <p class="mb-0">Early Bird Up to<br>
                                        <small>
                                            {{ \Carbon\Carbon::parse($registration->end_date_early)->format(' j F
                                                                                                                                                                                                                    Y') }}</small>
                                    </p>
                                    <div class="d-flex justify-content-center mb-4">
                                        <span class="h4 mb-0 mt-2">IDR</span>
                                        <span
                                            class="price h1 mb-0">{{ number_format($registration->price_idr_early, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="d-flex justify-content-center mb-4">
                                        <span class="h4 mb-0 mt-2">USD</span>
                                        <span
                                            class="price h1 mb-0">{{ number_format($registration->price_usd_early, 0, ',', '.') }}</span>
                                    </div>
                                @elseif ($currentDate <= \Carbon\Carbon::parse($registration->end_date_normal))
                                    <p class="mb-0">Regular Registration <br>
                                        <small>{{ \Carbon\Carbon::parse($registration->start_date_normal)->format(' j') }} -
                                            {{ \Carbon\Carbon::parse($registration->end_date_normal)->format(' j F
                                                                                                                                                                                                                        Y') }}</small>
                                    </p>
                                    <div class="d-flex justify-content-center mb-4">
                                        <span class="h4 mb-0 mt-2">IDR</span>
                                        <span
                                            class="price h1 mb-0">{{ number_format($registration->price_idr_normal, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="d-flex justify-content-center mb-4">
                                        <span class="h4 mb-0 mt-2">USD</span>
                                        <span
                                            class="price h1 mb-0">{{ number_format($registration->price_usd_normal, 0, ',', '.') }}</span>
                                    </div>
                                @else
                                    ...
                                    <div class="d-flex justify-content-center mb-4">
                                        <span class="h4 mb-0 mt-2">IDR</span>
                                        <span
                                            class="price h1 mb-0">{{ number_format($registration->price_idr_onsite, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="d-flex justify-content-center mb-4">
                                        <span class="h4 mb-0 mt-2">IDR</span>
                                        <span
                                            class="price h1 mb-0">{{ number_format($registration->price_usd_onsite, 0, ',', '.') }}</span>
                                    </div>
                                @endif

                                <ul class="list-unstyled mb-0 ps-0">
                                    <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                class="uil uil-check-circle align-middle"></i></span>{{ $registration->classReg->class_name }}
                                    </li>
                                </ul>
                ...
                <div class="col-md-4 mt-4 pt-2">
                    <ul class="nav nav-pills nav-justified flex-column bg-gradient-red-blue rounded shadow p-3 mb-0 sticky-bar"
                        ...
                        <li class="nav-item border rounded mt-2">
                            <a class="nav-link rounded" id="cardeography" data-bs-toggle="pill" href="#payment"
                        ...
                        <li class="nav-item border rounded mt-2">
                            <a class="nav-link rounded" id="eyecare" data-bs-toggle="pill" href="#info"
