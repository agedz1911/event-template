                    ...
                    <div class="card-body py-5">
                        ...
                        @if ($currentDate <= \Carbon\Carbon::parse($registration->end_date_early))
                            <p class="mb-0">Early Bird Up to<br>
                                <small> {{\Carbon\Carbon::parse($registration->end_date_early)->format(' j F
                                    Y')}}</small>
                            </p>
        ...
        <div class="row">
            <div class="col-md-4 mt-4 pt-2">
                <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-0 sticky-bar"
                    ...
                    <li class="nav-item mt-2 border border-1">
                        <a class="nav-link rounded" id="server" data-bs-toggle="pill" href="#cancellation" role="tab"
                            aria-controls="cancellation" aria-selected="false">
                            <div class="text-center py-1">
                    ...
                    <li class="nav-item mt-2 border border-1">
                        <a class="nav-link rounded" id="webdesigning" data-bs-toggle="pill" href="#onsite" role="tab"
                            aria-controls="onsite" aria-selected="false">
                            <div class="text-center py-1">
            ...
            <div class="col-md-8 col-12 mt-4 pt-2">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade bg-white show active p-4 rounded shadow" id="entitlement" role="tabpanel"
