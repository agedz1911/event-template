                ...
                <div class="card-body p-4">
                    ...
                    <form action="#">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="name" required="" placeholder="Enter Faculty Name">
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Country</label>
                            <input class="form-control" type="text" id="name" required="" placeholder="Enter Faculty Country">
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label" for="emailaddress">Image</label>
                            <input class="form-control" type="file" id="emailaddress" required="">
                        </div>
