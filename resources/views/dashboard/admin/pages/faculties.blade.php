                            ...
                            @foreach ($faculties as $faculty)
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            @if ($faculty->image != null)
                                                <img src="/assets/images/faculty/{{ $faculty->image }}"
                                                    alt="{{ $faculty->name }}" width="80px" class="img-">
                                            @else
                                        ...
                                        <td>
                                            <div>
                                                <a href="{{ url('/dashboard/admin/edit_faculties', $faculty->id) }}"
                                                    class="btn btn-secondary">Edit</a>
                                                <a href="{{ url('/dashboard/admin/delete_faculty', $faculty->id) }}"
