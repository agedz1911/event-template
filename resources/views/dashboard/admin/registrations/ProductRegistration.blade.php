                                ...
                                @foreach ($classCategory as $class)
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            {{-- <td>{{\Carbon\Carbon::parse($class->created_at)->format(' j F Y') }}</td> --}}
                                            <td>{{ $class->time }}</td>
                                            <td>
                                                <div>
                                                    <button class="btn btn-secondary btn-sm">Edit</button>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <small>early bird
                                                            Rp{{ number_format($product->price_idr_early, 0, ',', '.') }} |
                                                            USD{{ $product->price_usd_early }}</small>
                                                        <small>Normal
                                                            Rp{{ number_format($product->price_idr_normal, 0, ',', '.') }}
                                                            | USD{{ $product->price_usd_normal }}</small>
                                                        <small>Late / Onsite bird
                                                            Rp{{ number_format($product->price_idr_onsite, 0, ',', '.') }} |
                                                            USD{{ $product->price_usd_onsite }}</small>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <small>{{ \Carbon\Carbon::parse($product->start_date_early)->format(' j F Y') }}
                                                            Up to
                                                            {{ \Carbon\Carbon::parse($product->end_date_early)->format(' j F Y') }}</small>
                                                        <small>{{ \Carbon\Carbon::parse($product->start_date_normal)->format(' j F Y') }}
                                                            Up to
                                                            {{ \Carbon\Carbon::parse($product->end_date_normal)->format(' j F Y') }}</small>
                                                        <small>{{ \Carbon\Carbon::parse($product->start_date_onsite)->format(' j F Y') }}
                                                            Up to
                                                            {{ \Carbon\Carbon::parse($product->end_date_onsite)->format(' j F Y') }}</small>
                                                    </div>
                                                </td>
            ...
            <div class="modal-body p-4">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="needs-validation" action="{{ route('storeProductRegistration') }}"
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" id="product_name"
                                            name="product_name" required placeholder="Enter Registration Product">
                            ...
                            <div
                                class="d-lg-flex justify-content-between gap-2 border p-2 rounded align-items-center ">
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="start_date">Start Early Bird</label>
                                        <input class="form-control" type="date" id="start_date"
                                            name="start_date_early" required>
                                        <div class="invalid-feedback">
            ...
            <div class="modal-body p-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" action="{{ route('storeCategoryReg') }}" method="post"
                            novalidate>
                            @csrf
                            <div class="form-group mb-3">
                        ...
                        <form class="needs-validation" action="{{ route('storeClassCategory') }}" method="post"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="class_name" id="class_name"
                                    required placeholder="Input Class">
                                <div class="invalid-feedback">
