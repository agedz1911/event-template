            ...
            <div class="col-lg-6 mb-4">
                <div class="section-title ms-lg-4">
                    ...
                    <ul class="list-unstyled mb-0 text-muted">
                        ...
                        <li class="mb-0"><span class="text-muted h5 me-2"><i
                                    class="mdi mdi-chevron-double-right align-middle"></i></span>{{$item->title}}:
                            {{\Carbon\Carbon::parse($item->date)->format('l, j F Y')}}</li>
